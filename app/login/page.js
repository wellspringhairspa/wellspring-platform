    ...
    <div style={{minHeight:'100vh', backgroundColor:'#FAF7F2', display:'flex', alignItems:'center', justifyContent:'center', fontFamily:'Georgia, serif'}}>
      <div style={{backgroundColor:'white', padding:'48px', borderRadius:'8px', border:'1px solid rgba(122,139,111,0.2)', width:'100%', maxWidth:'400px'}}>
        ...
        <input
          ...
          style={{width:'100%', padding:'12px', border:'1px solid rgba(122,139,111,0.3)', borderRadius:'4px', marginBottom:'12px', fontSize:'0.95rem'}}
        />
        <input
          type="password"
          ...
          style={{width:'100%', padding:'12px', border:'1px solid rgba(122,139,111,0.3)', borderRadius:'4px', marginBottom:'24px', fontSize:'0.95rem'}}
        />
        <button onClick={() => handleAuth('login')} style={{width:'100%', padding:'14px', backgroundColor:'#7A8B6F', color:'white', border:'none', borderRadius:'4px', fontSize:'0.95rem', cursor:'pointer', marginBottom:'12px'}}>
          Log In
        </button>
